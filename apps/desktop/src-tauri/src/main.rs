...
fn main() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ai_music_companion::commands::set_pocket_mode,
            ...
            ai_music_companion::commands::warmup::start_daily_warmup,
            ai_music_companion::commands::warmup::complete_daily_warmup,
            ai_music_companion::commands::warmup::get_streak,
